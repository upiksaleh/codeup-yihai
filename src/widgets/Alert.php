...
use codeup\widgets\theming\Widget;
use Yii;
 ...
 * @author Upik Saleh <upxsal@gmail.com>
 */
class Alert extends \codeup\theming\Widget
{
    public $items = [];
    /**
    ...
    public function run()
    {
        ...
        foreach ($items as $type => $flash) {
            if (!isset($this->alertTypes[$type])) {
                continue;
            }

            foreach ((array) $items as $i => $message) {
                echo \codeup\theming\Alert::widget([
                    'body' => $message,
